...
Loads `../data/train.csv`, splits 85/15 train/val (seed=42), fits GloVe-mean-pooled + LR with `C=1.0`, scores on val, refits on all training data, writes Kaggle submission. Takes ~60–90 sec (GloVe table loads on first fit).
