...
Path resolution
---------------
This file lives at:  <repo_root>/mk_1/shared/preprocessing.py
The Kaggle CSVs live at:  <repo_root>/data/

So DATA_DIR is computed two parents up:
    HERE        = mk_1/shared
    HERE.parent = mk_1
...
# Paths --------------------------------------------------------------
HERE       = Path(__file__).resolve().parent      # mk_1/shared
MK_DIR     = HERE.parent                          # mk_1
REPO_ROOT  = MK_DIR.parent                        # repo root
DATA_DIR   = REPO_ROOT / "data"
