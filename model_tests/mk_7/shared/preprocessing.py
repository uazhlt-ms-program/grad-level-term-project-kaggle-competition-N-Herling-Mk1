...
Data path: <repo_root>/data/  (one level up from mk_7/).
"""
...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_7/shared
MK7_DIR   = HERE.parent                           # model_tests/mk_7
REPO_ROOT = MK7_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
