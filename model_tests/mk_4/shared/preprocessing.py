...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_4/shared
MK4_DIR   = HERE.parent                           # model_tests/mk_4
REPO_ROOT = MK4_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
