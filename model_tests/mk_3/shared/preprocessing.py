...
Data path: <repo_root>/data/  (one level up from mk_2/).
"""
...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_3/shared
MK3_DIR   = HERE.parent                           # model_tests/mk_3
REPO_ROOT = MK3_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
