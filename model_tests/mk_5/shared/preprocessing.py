...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_5/shared
MK5_DIR   = HERE.parent                           # model_tests/mk_5
REPO_ROOT = MK5_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
