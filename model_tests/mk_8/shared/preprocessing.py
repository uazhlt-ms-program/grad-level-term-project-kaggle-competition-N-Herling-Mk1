...
Data path: <repo_root>/data/  (one level up from mk_8/).
"""
...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_8/shared
MK8_DIR   = HERE.parent                           # model_tests/mk_8
REPO_ROOT = MK8_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
