...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_2/shared
MK2_DIR   = HERE.parent                           # model_tests/mk_2
REPO_ROOT = MK2_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
