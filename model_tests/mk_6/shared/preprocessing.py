...
Data path: <repo_root>/data/  (one level up from mk_6/).
"""
...
HERE      = Path(__file__).resolve().parent       # model_tests/mk_6/shared
MK6_DIR   = HERE.parent                           # model_tests/mk_6
REPO_ROOT = MK6_DIR.parent.parent  # repo root (one extra .parent because model_tests/ now in chain)
